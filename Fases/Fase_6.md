...
> Cada apartado es un fichero aparte, dentro de la carpeta `Fase_6/`. **Se leen en orden**, pero puedes volver a cualquiera: al final de cada uno tienes la navegación.
>
...
>
> El detalle: [[Fase_6.1_Que_Se_Evalua]]
