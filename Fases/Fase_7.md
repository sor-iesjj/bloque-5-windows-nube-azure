...
> Cada apartado es un fichero aparte, dentro de la carpeta `Fase_7/`. **Se leen en orden**, pero puedes volver a cualquiera: al final de cada uno tienes la navegación.
>
...
>
> El detalle: [[Fase_7.1_Que_Se_Evalua]]
