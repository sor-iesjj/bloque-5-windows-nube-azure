...
> Antes de sentarte a contestar las preguntas, **asegura el estado del servidor**. Con la grabación todavía en marcha, apaga la VM y toma la instantánea **`Fase 3 terminada`**.
>
