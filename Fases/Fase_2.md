...
> Cada apartado es un fichero aparte, dentro de la carpeta `Fase_2/`. **Se leen en orden**, pero puedes volver a cualquiera: al final de cada uno tienes la navegación.
>
...
| **10** | [[Fase_2.10_Auditoria_y_Cierre]] | Lo último — la checklist antes de seguir |
...
> **RA.01 · RA.05** — CE.01.e · CE.01.h · CE.05.d · CE.05.f
>
> El detalle: [[Fase_2.1_Que_Se_Evalua]]

**Siguiente al terminar los diez apartados:** Fase 3.
